...
export default async function ProduitPage({
  ...
  // Image: si tu as un mapping d'images Hiboutik -> URL absolue, mets-le ici
  const productImageAbsUrl = undefined; // ex: `${process.env.NEXT_PUBLIC_ASSETS}/images/${product.product_id}.jpg`

  return (
    <main className="mx-auto max-w-3xl mt-32 p-6">
      <div className="grid md:grid-cols-2 gap-6">
        {/* Placeholder image (remplace par ta vraie image) */}
